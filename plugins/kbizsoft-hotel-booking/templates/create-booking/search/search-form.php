...
<form method="GET" class="mphb_cb_search_form mphb-search-form vvi" action="<?php echo esc_url( $actionUrl ); ?>" data-first_available_check_in_date="<?php echo esc_attr( $firstAvailableCheckInDate ); ?>">
