 ...
 * @access public
 */
class Destination_Hotel_Booking_Customize_Section_Pro extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'destination-hotel-booking';
...
class destination_hotel_booking_Button extends WP_Customize_Section {
